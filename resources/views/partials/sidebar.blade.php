    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item {{ Request::is('kategori') ? 'active' : '' }}">
                    <a href="{{ route('kategori.index') }}" class="pc-link">
                        <span class="pc-micon"><i class="ti ti-typography"></i></span>
                        <span class="pc-mtext">Kategori Retribusi</span>
                    </a>
                </li>
                <li class="pc-item {{ Request::is('tipe') ? 'active' : '' }}">
                    <a href="{{ route('tipe.index') }}" class="pc-link">
                        <span class="pc-micon"><i class="ti ti-color-swatch"></i></span>
                        <span class="pc-mtext">Tipe Retribusi</span>
                    </a>
                </li>
                <li class="pc-item {{ Request::is('objek') ? 'active' : '' }}">
                    <a href="{{ route('objek') }}" class="pc-link">
                        <span class="pc-micon"><i class="ti ti-plant-2"></i></span>
                        <span class="pc-mtext">Objek Retribusi</span>
                    </a>
                </li>
                ...
                <li class="pc-item">
                    <a class="pc-link" href="{{ route('scanner') }}">
